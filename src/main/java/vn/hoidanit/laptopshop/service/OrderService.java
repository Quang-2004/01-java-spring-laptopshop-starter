...
public class OrderService {
    ...
    public void handleSaveOrderDetail(Cart cart, Order order, long productID) {
        ...
        if (cartDetailOptional.isPresent()) {
            ...
            productInventory.setQuantity(productInventory.getQuantity() - cartDetail.getQuantity());
            productInventory.setSold(productInventory.getSold() + cartDetail.getQuantity());
            // save
